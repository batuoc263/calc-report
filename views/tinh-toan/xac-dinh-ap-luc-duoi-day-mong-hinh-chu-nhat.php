        ...
        <form action="/tinh-toan/xac-dinh-ap-luc-duoi-day-mong-hinh-chu-nhat" method="post">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input required type="number" step="0.01" name="varN" id="varN"> kN
                    </td>
                </tr>
                <tr>
                    ...
                    <td> Mx = </td>
                    <td>
                        <input required type="number" step="0.01" name="varMx" id="varMx"> kN.m
                    </td>
                </tr>
                <tr>
                    ...
                    <td> Qy = </td>
                    <td>
                        <input required type="number" step="0.01" name="varQy" id="varQy"> kN
                    </td>
                </tr>
                <tr>
                    ...
                    <td> My = </td>
                    <td>
                        <input required type="number" step="0.01" name="varMy" id="varMy"> kN.m
                    </td>
                </tr>
                <tr>
                    ...
                    <td> Qx = </td>
                    <td>
                        <input required type="number" step="0.01" name="varQx" id="varQx"> kN
                    </td>
                </tr>
                <!-- ============ -->
                <tr>
                ...
                <tr>
                    ...
                    <td> l = </td>
                    <td>
                        <input required type="number" step="0.01" name="varL" id="varL"> kN
                    </td>
                </tr>
                <tr>
                    ...
                    <td> b = </td>
                    <td>
                        <input required type="number" step="0.01" name="varB" id="varB"> kN.m
                    </td>
                </tr>
                <tr>
                    ...
                    <td> h<sub>d</sub> = </td>
                    <td>
                        <input required type="number" step="0.01" name="varHd" id="varHd"> kN
                    </td>
                </tr>
                <tr>
                    ...
                    <td> h<sub>m</sub> = </td>
                    <td>
                        <input required type="number" step="0.01" name="varHm" id="varHm"> kN.m
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input required type="number" step="0.01" name="varGamma" id="varGamma"> kN
                    </td>
                </tr>
            </table>
